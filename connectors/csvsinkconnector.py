...
class CSVSinkConnector(MTCDeserializersMixin):
    ...
    Children have to define the following attributes:
     ...
     keys = ['key1' , 'key2']                     # List of keys of MTConnect DataItems that will be saved
     meta_data = ['key3', 'key4']                 # List of keys MTConnect DataItems that will be saved as meta data
    ...
    def load_current(self):
        ...
        'current' contains the state of the MTConnect device in form of:
         - the current values of all keys in 'keys'
         - the kafka_offset of the latest message read
    ...
    def get_storage_folder(self):
        ...
        The recieved value of the 'start_key' is used to create
